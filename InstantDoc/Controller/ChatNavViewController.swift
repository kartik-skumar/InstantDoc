...
//  InstantDoc
//
//  Created by Kartik's MacG on 30/05/18.
...
class ChatNavViewController: UINavigationController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate {
